...
export default function DatasetsListPage() {
  ...
  const fetchDatasets = async () => {
    ...
    try {
      ...
      setError(
        "Błąd podczas pobierania zbiorów danych: " +
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {publicDatasets.map((dataset) => (
                  <div
                    key={dataset.id}
                    className="border rounded-lg p-4 hover:shadow-md bg-green-50"
                  >
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {userDatasets.map((dataset) => (
                  <div
                    key={dataset.id}
                    className="border rounded-lg p-4 hover:shadow-md bg-blue-50 relative"
                  >
                    <h4 className="font-semibold text-lg mb-2">
                      {dataset.name}
                    </h4>
